...
<div class="filmworld-auth-page">
    ...
    <div class="filmworld-auth-card">
        ...
        <form id="filmworld-register-form" class="filmworld-auth-form">
            ...
            <button type="submit" class="filmworld-auth-btn">ثبت‌نام</button>
...
<!-- همون استایل‌های login رو دوباره نمی‌نویسیم چون هدر/فوتر مشترکه و استایل توی login.php هست -->
<!-- ولی چون هر صفحه جدا لود میشه، استایل رو اینجا هم تکرار می‌کنم -->
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        .then(function (data) {
            ...
            if (data.success) {
                msg.innerHTML = '<div class="filmworld-auth-notice filmworld-auth-notice-success">ثبت‌نام موفق! در حال انتقال...</div>';
                setTimeout(function () {
